...
export const ProcessData = [
  {
    heading: "Take care with love",
    description:
      "We take care your package with full of attention and of course full of love. We want to make sure you’ll receive your packagelike you receive your birthday gift.",
    icon: FavoriteIcon,
  },
  {
    heading: "Friendly Customer Service",
    description:
